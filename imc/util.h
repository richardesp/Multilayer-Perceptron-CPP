...
namespace util {
    ...
    // Split the training dataset given a percentage of the dataset to be used for training
    Dataset *splitDataset(Dataset *trainDataset, float validationSplit, long long seed = 0);
};
